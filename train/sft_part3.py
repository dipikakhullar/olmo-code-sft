...
def main():
    ...
    # The Trainer automatically finds the latest checkpoint if resume_from_checkpoint is True.
    if config.resume:
        print(f"INFO: Resuming training from the latest checkpoint in {config.output_dir}")
